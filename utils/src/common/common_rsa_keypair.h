...
/* Global defines */
#define RSA_PRIVATE_KEY_SIZE     BSV_CERT_RSA_KEY_SIZE_IN_BITS
#define NP_SIZE_IN_BYTES         20
#define NEW_PKA_WORD_SIZE_BITS	 CC_PKA_WORD_SIZE_IN_BITS
#define NEW_PAK_ADDITIONAL_BITS  8
#define SNP                      BSV_CERT_RSA_KEY_SIZE_IN_BITS + NEW_PKA_WORD_SIZE_BITS + NEW_PAK_ADDITIONAL_BITS -1
 ...
 */
/*********************************************************/
SBUEXPORT_C int32_t CC_CommonRsaCalculateNp(const uint8_t* N_ptr, uint8_t *NP_ptr);
