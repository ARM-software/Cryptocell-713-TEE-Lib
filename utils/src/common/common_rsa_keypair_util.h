...
typedef struct {
	uint8_t pNBuff[BSV_CERT_RSA_KEY_SIZE_IN_BYTES];
...
*/
/*********************************************************/
int32_t CC_CommonGetNAndNpFromKeyPair(char *PemEncryptedFileName_ptr, char *pwdFileName, uint8_t *pNAndNp, uint32_t *pNAndNpSize);
