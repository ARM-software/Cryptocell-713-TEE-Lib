...
def CreateCertUtility(sysArgsList):
    try:
        ...
        dataToSign = build_certificate_header (log_file, DEBUG_ENABLER_TOKEN, ProjDict, LIST_OF_CONF_PARAMS, data_dict['rma_mode'], data_dict['hbk_id'], data_dict['lcs'], data_dict['add_data'])
        if dataToSign == None:
