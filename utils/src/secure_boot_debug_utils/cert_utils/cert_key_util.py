...
def CreateCertUtility(sysArgsList):
    try:
        ...
        ArgsDict, config = key_cert_config_file_parser(config_fname, log_file, ProjDict)
        if ArgsDict == None:
        ...
        CertDataList.append(CertHeader(log_file, LIST_OF_CONF_PARAMS, ArgsDict['hbk_id'], CERT_TYPE_KEY, 0, 0, 0, 0, ProjDict, ArgsDict['add_data']))
