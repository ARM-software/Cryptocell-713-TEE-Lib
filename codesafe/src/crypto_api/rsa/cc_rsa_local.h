...
*/
CCError_t RsaPssOaepEncode(CCRndGenerateVectWorkFunc_t f_rng, /* Pointer to DRBG function*/
                             void *p_rng,                       /* Pointer to the random context - the input to f_rng. */
 ...
 */
CCError_t RsaPssSign21(CCRndGenerateVectWorkFunc_t f_rng, /*in*/
                                void *p_rng,                         /*in/out*/
 ...
 *                       value MODULE_* as defined in ...
 */
CCError_t CC_RsaGenerateVectorInRangeX931(CCRndGenerateVectWorkFunc_t f_rng,
                                               void *p_rng,
 ...
 * @return CCError_t
 */
CCError_t  RsaGenRndNonZeroVect(CCRndGenerateVectWorkFunc_t f_rng, void *p_rng, uint8_t *pVect, uint32_t size);
