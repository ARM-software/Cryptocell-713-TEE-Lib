						 ...
						 CCRsaKgFipsContext_t    *pFipsCtx)
{
        ...
        error = KGCheckAndSetParamsRSA( PubExp_ptr,
					PubExpSizeInBytes,
					KeySize,
					pCcUserPrivKey,
					pCcUserPubKey,
        ...
        error = FIPS_RSA_VALIDATE(f_rng, p_rng, pCcUserPrivKey,pCcUserPubKey,pFipsCtx);
...
/**
   ...
   @param [in]  f_rng - The pointer to DRBG function
   @param [in,out]  p_rng - The pointer to the random context - the input to f_rng.
   @param [in] PubExp_ptr - The pointer to the public exponent (public key)
                                                ...
                                                CCRsaKgFipsContext_t *pFipsCtx )
{
        ...
        /* .......... initializing the key sizes  ......................... */
        pSizeWords =(uint16_t) KeySize / (2*CC_BITS_IN_32BIT_WORD);
...
#define  MIN_VAL 0xB504F334  /* minimal value of MS word of rnd vect. */
