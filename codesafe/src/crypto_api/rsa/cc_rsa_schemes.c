...
/**
   ...
   @param [in] f_rng - A pointer to DRBG function
   @param [in,out] p_rng - A pointer to the random context - the input to f_rng.
                                             ...
                                             CCPkcs1Version_t PKCS1_ver)
{
	...
	CHECK_AND_RETURN_ERR_UPON_FIPS_ERROR();
        ...
        if (f_rng == NULL){
                    return CC_RSA_INVALID_INPUT_POINTER;
        }
        ...
        case CC_PKCS1_VER15:
                ...
                Error = RsaGenRndNonZeroVect(f_rng, p_rng, &EB_buff[2], PSSize);
                if (Error != CC_OK) {
                        goto End;
		}
                /* 0-byte after PS */
        ...
        case CC_PKCS1_VER21:
                ...
                Error=RsaPssOaepEncode(
                                             f_rng,        /*! random functions */
                                             p_rng,        /*! random context*/
