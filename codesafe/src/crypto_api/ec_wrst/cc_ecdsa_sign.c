                                    ...
                                    CCEcpkiHashOpMode_t      hashMode          /*in*/ )
{
        ...
        if (regVal == SECURE_DISABLE_FLAG_SET) {
            return CC_ECDSA_SIGN_SD_ENABLED_ERR;
        }
        ...
        if (regVal == FATAL_ERROR_FLAG_SET) {
            return CC_ECDSA_SIGN_FATAL_ERR_IS_LOCKED_ERR;
        }
                                           ...
                                           uint32_t                       *pEphemerKeyData   /*in*/)
{
        ...
        /* check the user context pointer */
        if (pSignUserContext == NULL){
                return CC_ECDSA_SIGN_INVALID_USER_CONTEXT_PTR_ERROR;
        }
        ...
        /* ********  Call LLF ECDSA Signature function  ************ */
        err =  EcWrstDsaSign(
                                     ...
                                     size_t                          *pSignOutSize           /*in*/)
{
        ...
        /*****  EcdsaSignFinish  ********/
        err = EcdsaSignFinish(pSignUserContext, f_rng, p_rng,
