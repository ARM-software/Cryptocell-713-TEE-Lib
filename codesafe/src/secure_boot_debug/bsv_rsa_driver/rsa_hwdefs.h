...
#define RSA_HW_PKI_PKA_N_NP_T0_T1_REG_N_POS                         CC_REG_BIT_SHIFT(N_NP_T0_T1_ADDR, N_VIRTUAL_ADDR)
#define RSA_HW_PKI_PKA_N_NP_T0_T1_REG_NP_POS                        CC_REG_BIT_SHIFT(N_NP_T0_T1_ADDR, NP_VIRTUAL_ADDR)
#define RSA_HW_PKI_PKA_N_NP_T0_T1_REG_T0_POS                        CC_REG_BIT_SHIFT(N_NP_T0_T1_ADDR, T0_VIRTUAL_ADDR)
#define RSA_HW_PKI_PKA_N_NP_T0_T1_REG_T1_POS                        CC_REG_BIT_SHIFT(N_NP_T0_T1_ADDR, T1_VIRTUAL_ADDR)
...
do \
{ \
   uint32_t output_reg_val = 0; /* Trust in Soft initialization - __TRUSTINSOFT_ANALYZER__ */ \
   do \
   { \
...
/************************ Defines ******************************/
#define LEN_ID_MAX_BITS 7 /*size of PKA registers */
/* ********************** Macros ******************************* */
