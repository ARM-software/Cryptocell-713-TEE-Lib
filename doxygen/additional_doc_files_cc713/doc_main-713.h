/*!
   ...
   @mainpage Arm® CryptoCell-713™ Runtime Software API overview

    This documentation describes the runtime software APIs provided by Arm CryptoCell-713.
    ...
    The API layer enables using the CryptoCell cryptographic algorithms, such as AES, hash, RSA, and ECC.

    The API layer enables use of the following algorithms and features:
    <ul>
        <li>AES</li>
        <li>Diffie-Hellman-Merkle</li>
        <li>RSA</li>
        <li>Elliptic Curves Cryptography (ECC)</li>
