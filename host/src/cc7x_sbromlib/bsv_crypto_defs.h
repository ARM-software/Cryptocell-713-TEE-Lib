...
typedef enum
{
    ...
    BSV_CRYPTO_COMPLETION_WAIT_UPON_START = 1,  /*!< The driver waits before starting a new chunk of data. */
    BSV_CRYPTO_COMPLETION_WAIT_UPON_END = 2     /*!< The driver waits after each chunk of data. */
...
#define CC_BSV_AES_IV_SIZE_IN_BYTES        16
...
/*! AES IV buffer. A 16-Byte array. */
typedef uint8_t CCBsvAesIv_t[CC_BSV_AES_IV_SIZE_IN_BYTES];
