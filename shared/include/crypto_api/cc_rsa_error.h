...
/*!
 @addtogroup cc_rsa_error CryptoCell RSA specific errors
 @{
*/
...
#define CC_RSA_FATAL_ERR_IS_LOCKED_ERR                  (CC_RSA_MODULE_ERROR_BASE + 0x62UL)
/*! Secure Disable control is set */
#define CC_RSA_SD_ENABLED_ERR                           (CC_RSA_MODULE_ERROR_BASE + 0x63UL)
