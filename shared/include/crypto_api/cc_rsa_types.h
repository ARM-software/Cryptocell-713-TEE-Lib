...
#define CC_RSA_MIN_VALID_KEY_SIZE_VALUE_IN_BITS              2048
...
/*! Salt length definition - if the salt length is not available in verify operation, you can use this define and the algorithm
    calculates the salt length on its own.*/
...
/*! The public key's user structure prototype. This structure must be saved by the user,
and is used as input to the RSA functions, such as ::CC_RsaSchemesEncrypt. */
...
/*! The private key's user structure prototype. This structure must be saved by the user,
and is used as input to the RSA functions such as ::CC_RsaSchemesDecrypt. */
...
typedef struct
{
	...
	/*! Internal buffer used size in bits. */
...
/*! The context prototype of the user - the argument type that is passed by the user
