...
#define CC_AES_FATAL_ERR_IS_LOCKED_ERR                (CC_AES_MODULE_ERROR_BASE + 0x17UL)
/*! Device has security disable feature enabled. */
#define CC_AES_SECURE_DISABLE_ERROR                   (CC_AES_MODULE_ERROR_BASE + 0x18UL)
/*! Illegal parameters. */
