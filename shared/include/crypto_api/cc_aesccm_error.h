...
/*!
@file
@brief This file contains the definitions of the CryptoCell AES-CCM errors.
*/

/*!
@addtogroup cc_aesccm_error
@{
*/

/************************ Defines ******************************/

/* CryptoCell AES-CCM module errors. CC_AESCCM_MODULE_ERROR_BASE = 0x00F01500 */
...
/*! AES-CCM is not supported. */
#define CC_AESCCM_IS_NOT_SUPPORTED                       (CC_AESCCM_MODULE_ERROR_BASE + 0xFFUL)
/*! Illegal Nonce parameter. */
#define CC_AESCCM_ILLEGAL_NONCE_ERROR                (CC_AESCCM_MODULE_ERROR_BASE + 0x11UL)
